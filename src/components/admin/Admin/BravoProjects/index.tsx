...
import { V3BravoProjectsService } from "../../../../client/index.ts";
...
const BravoProjects = () => {
  ...
  const {
    ...
    async ({ pageParam = 0 }) => {
      ...
      const data = await V3BravoProjectsService.readPublicBravoProjects(pageParam, pageSize, preview);
