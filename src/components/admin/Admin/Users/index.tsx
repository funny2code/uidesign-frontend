import { getUserData, getUsers, updateUser, getUserPoolData } from "./utils";
            ...
            <section className="py-0">
              {selected && (
                <table className="table">
                  ...
                  <tbody>
                    <tr>
                      <td>{selected.UserAttributes.find(attr => attr.Name === "email")?.Value}</td>
                      <td>
                        <input
                          type={"checkbox"}
                          ...
                          onChange={async () => {
                            ...
                            const email = selected.UserAttributes.find(
