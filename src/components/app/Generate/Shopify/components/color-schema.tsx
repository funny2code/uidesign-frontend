...
const ColorSchema = ({data, settings, handleChangeFields}: {data: ISchemaItem, settings: any, handleChangeFields: (e: any) => void}) => {
    ...
    return (
        <div className="py__settings-item">
            ...
            <div className="py__comp-select">
                <select defaultValue={settings[data.id]} name={data.id} data-type="select" onChange={handleChangeFields}>
