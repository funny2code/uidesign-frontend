...
const TextComp = ({data, settings, handleChangeFields}: {data: ISchemaItem, settings: any, handleChangeFields: (e: any) => void}) => {

    // { data.info && (
    //     <div className="py__tooltip">
    ...
    return (
        <div className="form-floating mb-2">
            <input type="text" onChange={(e) => console.log(e.target.value)} name={data.id} className="form-control" value={settings[data.id]} />
