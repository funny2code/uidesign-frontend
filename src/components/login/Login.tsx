        ...
        <>
            {
                ...
                <form id="signup-form" onSubmit={handleSubmitSignup} className="vstack gap-3 form">
                    ...
                    <div className="vstack gap-1">
                        ...
                        <input className="form-control" type="email" placeholder="email@google.com" value={email} onChange={(e) => setEmail(e.target.value)} />
                    ...
                    <div className="vstack gap-1">
                        ...
                        <span className="form-text text-muted">At least 8 characters, lower case, upper case, and symbols.</span>
                    </div>
                    <div className="vstack gap-3">
                        <span className="form-text text-danger">{error && error}</span>
                        <a className="text-success" style={{cursor: "pointer"}} onClick={() => handlePageChange(false)}>Back to Login</a>
                ...
                <form id="login-form" onSubmit={handleSubmitLogin} className="vstack gap-3 form">
                    ...
                    <div className="vstack gap-1">
                        <label className="form-label">Email Address</label>
                        <input className="form-control" type="text" placeholder="email@google.com" value={email} onChange={(e) => setEmail(e.target.value)}/>
                    </div>
                    <div className="vstack gap-1">
                        <label className="form-label">Password</label>
                        <input className="form-control" type="password" placeholder="password" value={password} onChange={(e) => setPassword(e.target.value)}/>
                    ...
                    <div className="vstack gap-3">
                        ...
                        <span className="form-text text-danger">{error && error}</span>
                        <a className="text-success" style={{cursor: "pointer"}} onClick={() => handlePageChange(true)}>Create Account</a>
                        {
                            isLoading ? <div id="loading" className="spinner-border" role="status"></div> 
